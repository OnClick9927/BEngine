...
public sealed class CodexProjectStore
{
    ...
    public CodexProjectSettingsDocument LoadSettings()
    {
        ...
        var settings = YamlUtility.Load<CodexProjectSettingsDocument>(SettingsPath);
    ...
    public void SaveSettings(CodexProjectSettingsDocument settings) => YamlUtility.Save(settings, SettingsPath);
    ...
    public void SaveSession(CodexSessionDocument session)
    {
        ...
        YamlUtility.Save(session, SessionPath);
    }
