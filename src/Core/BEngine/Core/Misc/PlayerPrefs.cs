...
public static class PlayerPrefs
{
    ...
    public static void DeleteKey(string key) { lock (Gate) Values.Remove(key); }
    public static void DeleteAll() { lock (Gate) Values.Clear(); }
    ...
    public static void Save() { lock (Gate) new PlayerPrefsDocument { Values = Values }.Save(FilePath); }
