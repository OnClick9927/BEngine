...
public sealed class ProjectSettingsDocument : Document
{
    ...
    public List<SortingLayerDocument> SortingLayers { get; set; } = CreateDefaultSortingLayers();

    private static List<SortingLayerDocument> CreateDefaultSortingLayers() =>
