...
internal static class Program
{
    private static int Main()
    {
        try
        {
            ...
            Console.WriteLine(
                "INSPECTOR_COMPONENT_ACTIONS_OK|gameobject-header,component-chrome,context-menu,reset,copy,paste,complex-clipboard,missing-component-clipboard,edit-script,remove,local-transform,structural-undo,require-component-undo,required-removal-guard,readonly");
            return 0;
        }
